...
class CycleGAN():
    ...
    def backward_G(self):
        ...
        self.loss_G_A = loss_G_A.data + loss_cycle_G_A.data * self.opt.gamma + prior_loss_G_A.data
        self.loss_G_B = loss_G_B.data + loss_cycle_G_B.data * self.opt.gamma + prior_loss_G_A.data
        self.loss_cycle_A = loss_cycle_A.data
        self.loss_cycle_B = loss_cycle_B.data
        self.loss_kl_EA = loss_kl_EA.data
        self.loss_kl_EB = loss_kl_EB.data
